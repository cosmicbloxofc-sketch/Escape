...
-- SALES API CONFIG
local API_KEY = "E4RT21VCXZN73546@#s2SGshny262JA7@SAJ2$%7SA@"
local BASE_URL = "https://rnqcdldfaboypyukvnhf.supabase.co/functions/v1"
            ...
            task.spawn(function()
                ...
                while isGifting do
                    ...
                    if not guid then
                        ...
                        -- NOVO: Registra venda se os itens foram enviados (currentInv < lastInventory)
                        if currentInv < lastInventoryCount then
                            -- Como o loop de envio pode mandar vários trades, 
                            -- tentamos identificar o que foi enviado.
                            -- (Simplificação baseada no comportamento do script-end.lua original)
                            registrarVenda(selectedItemName, selectedTargetName, "Normal") 
                        end
